...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!--[if IE 9]><link rel="stylesheet" href="css/style-ie9.css" /><![endif]-->
                <!--script que mostra a hora do sistema -->
	...
	<body>
    <div id="toplogo" class="5grid-layout">
    </div>
				...
				<div class="5grid-layout">
					<div class="row">
						<div class="4u" id="logo">
							<h1><a href="#" class="mobileUI-site-name">Arquivos</a></h1>
						</div>
		...
		<div id="wrapper" class="5grid-layout">
			...
			<div id="page" class="row">
				...
				<div id="content" class="12u">
					...
					<!-- Main Content Area -->
					<section>
						<h2 class="main-title">ÍNDICE DE ARQUIVOS</h2>
						<a href="#" class="image-style1"><img src="images/pic02.jpg" alt=""></a>
						<p>Página para incicar arquivos que estão sendo armazenados e processados em minha rede semântica. O valor e a utilização destes arquivos, bem como sua manutenção depende do cumprimento das contingências básicas necessárias. Sendo assim primar pela otimização do tempo e pela organização das atividades de agenda, bem como encontrar meios de manter o sistema funcionando em sua hierarquia de aquizições básicas é fator cricial para a boa utilização deste arquivos... boa sorte!!!</p>
						<ul class="style5">
		...
		<div class="5grid-layout" id="copyright">
			<div class="row">
				<div class="12u">
					<section>
                    <p align="center">
                    <?php include "dados_site.inc"; ?>					 
					</p>
                    <p align="center">
                    <?php include "dataatual.inc"; ?>
                    </p>
                    <p align="center">
                    <script type="text/javascript">
					document.write ("A hora atual é: "+horas+":"+minutos+":"+segundos);
					</script>
                    </p>
                    </section>
				</div>
